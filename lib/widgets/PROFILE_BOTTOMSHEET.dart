...
void showprfileBottomsheet ({
  ...
  showModalBottomSheet(
    ...
    return Padding(
      padding: const EdgeInsets.only(left: 12.0, right:  12, top: 20, bottom: 10),
      child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Transform(
                          ...
                          child: Image.asset('assets/profile_pic.png',scale: 2,)),
                  ...
                  Flexible(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text('#289' ,style: TextStyle(
                     fontFamily: 'BebasNeue',
                     fontSize: 35.sp,
                        fontWeight: FontWeight.bold
                    ),),
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        Expanded(
                          flex: 10,
                          child: Text('MISSION\N COMPLETED', style: TextStyle(
                              fontFamily: 'BebasNeue',
                              fontSize: 19.sp,
                              fontWeight: FontWeight.bold
                          ),
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text('1.13' ,style: TextStyle(
                                        fontFamily: 'BebasNeue',
                                        fontSize: 38.sp,
                                        fontWeight: FontWeight.bold
                                    ),),
